...
const languageStrings = {
    en: {
        translation: {
            ...
            HOLA_MESSAGE: 'Hello wourld',
            END_MESSAGE: 'see you later!',
            LS_MESSAGE: 'Sorry, I don\'t know about that. Please try again.'
        }
    },
    es:{
        translation: {
            ...
            HOLA_MESSAGE: 'Hola mundo',
            END_MESSAGE: 'Hasta luego!',
            LS_MESSAGE: 'Lo siento, no sé nada de eso. Inténtalo de nuevo'
        }
    }
}
...
const HelloWorldIntentHandler = {
    ...
    handle(handlerInput) {
        const requestAttributes = handlerInput.attributesManager.getRequestAttributes();
        const speakOutput = requestAttributes.t('HOLA_MESSAGE');
